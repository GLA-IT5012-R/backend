...
class Order(models.Model):
    """
    Order table, each record is an order, related to user and has multiple order items
    """
...
class Cart(models.Model):
    """
    cart item table, each record is a customised product in user's cart
    ...
    class Meta:
        db_table = "m_cart"
        ordering = ["-created_at"]
        unique_together = ("user_id", "design")  # prevent duplicate cart items for the same user and design
